...
var Actions = /** @class */ (function () {
    ...
    Object.defineProperty(Actions.prototype, "dispatcher", {
        get: function () {
    ...
    Object.defineProperty(Actions.prototype, "committer", {
        get: function () {
...
var Context = /** @class */ (function () {
    ...
    Object.defineProperty(Context.prototype, "committer", {
        get: function () {
            var _this = this;
            ...
            return (this.__committer__ = committer);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Context.prototype, "dispatcher", {
        get: function () {
            ...
            return (this.__dispatcher__ = dispatcher);
        },
        enumerable: true,
        configurable: true
    });
...
function createStore(rootModule, options) {
    ...
    var store = new Store(__assign({}, options, rootModuleOptions, { plugins: [injectStore].concat(options.plugins || []) }));
    return store;
}

export { Module, createStore, Getters, Mutations, Actions, inject, Context, registerModule, unregisterModule };
